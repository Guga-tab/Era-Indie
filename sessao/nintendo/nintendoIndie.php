...
<head>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="../../css/nintendoindie.css">
...
<body>
    <header class="nav">
        ...
        <div class="modulo">
          <img id="nIndie" src="https://2.bp.blogspot.com/-0anuofukoBA/W4gLYatHmuI/AAAAAAAAAyM/-QEyaGz5p_E0lE0REWvdXyhlPEnQakqKACLcBGAs/s1600/capatop10indies.jpg" alt="">
          <h2 class="titulo">Nintendo Indie World Games Indie lançados no Nintendo Switch.</h2>
          <p id = public>Gustavo Machado- 18.10.2022 Às 11H33</p>
          <p class="conteudo"> A Nintendo realiza o Nintendo Indie World, uma apresentação<br> 
            que irá divulgar e promover novos jogos indie para o Nintendo Switch.<br> 
            O evento ocorre anualmente, sendo transmitido<br>
        
            em diversos canais de comunicação.</p>
        </div>
